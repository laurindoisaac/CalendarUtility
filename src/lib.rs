// src/lib.rs
/*
 * Core library for CalendarUtility
 */
...
#[derive(Debug)]
pub struct CalendarUtilityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CalendarUtilityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CalendarUtility processing");
    
    let mut processor = CalendarUtilityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CalendarUtilityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CalendarUtilityProcessor::new(false);
